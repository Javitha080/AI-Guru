...
export const CO_WRITER_SAMPLE_TEMPLATE = `# AI Guru Co-Writer

> AI Guru's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for AI Guru product docs and learning content

## Headers (Underline)

AI Guru Learning Note
=============

AI Guru Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers AI Guru while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> AI Guru helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [AI Guru](#deeptutor-co-writer)

### Links

[AI Guru Co-Writer](#deeptutor-co-writer "co-writer section")

[AI Guru Learning Note](#deeptutor-learning-note)

[AI Guru Website](https://deeptutor.info)
...
> AI Guru brand mark used inside the co-writer template.
...
- [x] Draft a AI Guru product note
...
op=>operation: AI Guru analyzes intent
...
${FENCE}seq
Student->AI Guru: Ask for help
AI Guru->KnowledgeBase: Load context
Note right of AI Guru: Collect memory\\nand relevant knowledge
AI Guru-->Student: Return guided response
Student->>AI Guru: Request rewrite in co-writer
${FENCE}
