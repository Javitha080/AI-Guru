 ...
 * consult within one AI Guru chat is archived as one partner session.
 */
        ...
        action={
          canConnect ? (
            <button
              ...
              className="inline-flex items-center gap-1.5 glass-btn-primary px-3 py-1.5 text-[12px] font-medium transition-opacity hover:opacity-90"
            >
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {connections.map((conn) => {
            ...
            return (
              <div
                key={conn.name}
                className="group flex items-center gap-3 surface-glass-elevated liquid-sheen rounded-2xl border border-[var(--glass-border)] px-4 py-3"
              >
                {partner ? (
                  <PartnerAvatar
                    name={partner.name}
      ...
      >
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button
            ...
            onClick={() => void submit()}
            disabled={submitting}
            className="inline-flex items-center gap-1.5 glass-btn-primary px-3.5 py-1.5 text-[12.5px] font-medium transition-opacity hover:opacity-90 disabled:opacity-50"
          >
            {submitting ? (
              <Loader2 className="h-3.5 w-3.5 animate-spin" />
            ) : (
