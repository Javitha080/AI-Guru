...
export default function SettingsMain({
  ...
  if (isHub) {
    return (
      <div className="h-full overflow-y-auto surface-glass-base [scrollbar-gutter:stable]">
  ...
  return (
    <div className="flex h-full min-w-0 flex-col overflow-hidden surface-glass-base">
