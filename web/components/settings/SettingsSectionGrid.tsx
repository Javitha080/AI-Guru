 ...
 * services, active model name, and a blurb.
 */
  ...
  return (
    <div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {leaves.map((leaf) => {
          const activeModel = leaf.service ? getActiveModel(catalog, leaf.service) : null;
          const activeProfile = leaf.service ? getActiveProfile(catalog, leaf.service) : null;
          const activeDetail = activeModel?.name || activeModel?.model || activeProfile?.name;
