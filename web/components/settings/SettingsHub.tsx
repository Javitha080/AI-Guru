    ...
    <div>
      <header className="mb-7 flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="font-display text-[24px] font-semibold leading-tight tracking-tight text-[var(--foreground)]">
        ...
        <button
          type="button"
          onClick={startTour}
          className="inline-flex shrink-0 items-center gap-1.5 px-3 py-1.5 text-[12.5px] font-medium glass-btn-secondary"
        >
          <Rocket size={13} />
          {tr({ zh: "引导", en: "Tour" })}
        </button>
...
function CategoryBlock({
  ...
  return (
    <Link
      ...
      className="group relative flex min-h-[120px] flex-col justify-between rounded-2xl p-5 transition-all duration-300 surface-glass-elevated liquid-sheen hover:shadow-[0_8px_32px_-12px_rgba(0,0,0,0.4)] hover:-translate-y-0.5"
    >
...
function ModelPreview({
  ...
  return (
    <div className="flex items-center gap-2.5">
      <div className="flex items-center gap-1 glass-capsule px-2 py-1">
              ...
              state === "passed"
                ...
                : state === "failed"
                  ...
                  : state === "untested"
                    ...
                    : "bg-zinc-300/60 dark:bg-zinc-700 text-zinc-500"
            }`}
          />
        ))}
      </div>
