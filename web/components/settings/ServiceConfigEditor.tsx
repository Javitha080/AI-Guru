    ...
    <div data-tour={`tour-${service}`} className="space-y-5">
      {activeProfile ? (
        <div className="grid grid-cols-[200px_minmax(0,1fr)] items-start gap-5">
          ...
          <aside className="sticky top-4 self-start rounded-2xl border border-[var(--glass-border)] surface-glass-elevated p-2">
                  ...
                  <div
                    ...
                    className={`group relative cursor-pointer rounded-lg px-3 py-2 text-left transition-colors ${
                      isActive
                        ...
                        : "text-[var(--muted-foreground)] hover:bg-[var(--glass-0)]"
                    }`}
                  >
                    {isActive && (
            ...
            <div className="mt-2 border-t border-[var(--glass-border)]/40 pt-2">
              <button
          ...
          <div className="min-w-0 space-y-5">
            <div className="rounded-2xl border border-[var(--glass-border)] surface-glass-elevated liquid-sheen p-5">
            ...
            <div className="rounded-2xl border border-[var(--glass-border)] surface-glass-elevated liquid-sheen">
              <div className="flex items-center justify-between px-5 py-3.5">
                ...
                <div className="ml-3 flex items-center gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[12px] glass-btn-secondary disabled:opacity-40"
                  >
                    {t("Run test")}
                  </button>
                  <button
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-[var(--glass-border)] px-5 py-12 text-center text-[13px] text-[var(--muted-foreground)] surface-glass-elevated">
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      {fields.baseUrl && (
        <div className="sm:col-span-2">
          ...
          {service === "embedding" && (
            <p className="mt-1.5 text-[11px] text-[var(--muted-foreground)]">
              {t(
                "Embedding requests are sent to this URL exactly; AI Guru does not append /embeddings or /api/embed at request time.",
              )}
            </p>
          )}
        ...
        <div className="sm:col-span-2">
          ...
          <div className="relative">
            <input
              ...
              spellCheck={false}
              className={`${inputClass} pr-10 font-mono glass-input`}
      ...
      {!isCodexOAuth && (
        <div className="sm:col-span-2 rounded-xl border border-[var(--border)]/60 bg-[var(--muted)]/20">
          ...
          {extraOpen && (
            <div className="grid gap-4 border-t border-[var(--glass-border)]/60 px-3.5 py-4 sm:grid-cols-2">
              <div>
                <div className="mb-1.5 text-[12px] text-[var(--muted-foreground)]">
                  {t("API Version")}
                </div>
