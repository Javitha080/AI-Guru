...
const SEND_STATE_CLASS: Record<SendState, string> = {
  ...
  blocked:
    "glass-btn-primary text-[var(--foreground)] opacity-50 hover:opacity-75",
  ready:
    "glass-btn-primary text-[var(--primary-foreground)] hover:-translate-y-px",
  streaming: "glass-btn-primary text-[var(--primary-foreground)]",
};
...
export default memo(function ChatComposer({
  ...
  /** Max times AI Guru may consult the selected agent this turn. */
  ...
  return (
    <div
      ref={composerRef}
      className={`relative z-20 mx-auto w-full shrink-0 px-6 pb-5 mb-6 ${hasMessages ? "pt-1 max-w-[960px]" : "max-w-[768px]"}`}
      style={{
    ...
    >
      ...
      <div className="relative">
        <div
          className={`relative rounded-[26px] border surface-glass-elevated liquid-sheen shadow-[0_1px_2px_rgba(0,0,0,0.025),0_10px_28px_-10px_rgba(0,0,0,0.08)] transition-colors ${
            dragging
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="relative block h-16 w-16 overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--card)] transition-shadow hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]/40 glass-btn-ghost"
                      >
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      onClick={() => onPreviewAttachment?.(i)}
                      aria-label={previewLabel}
                      className="group/att relative flex items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--card)] px-2 py-1.5 transition-colors hover:border-[var(--primary)]/30 hover:bg-[var(--muted)]/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]/40 glass-btn-ghost"
                    >
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="relative flex min-w-0 flex-1 items-center">
                <button
                  ...
                  className={`relative flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition-[background-color,color,transform] duration-150 active:scale-90 glass-btn-ghost ${
                    spaceMenuOpen
