  ...
  return (
    <div className="space-y-3">
      <button
        ...
        onDrop={handleDrop}
        disabled={disabled}
        className={`group flex w-full flex-col items-center justify-center gap-2 rounded-lg border border-dashed text-center transition-all duration-300 ${padding} ${
          dropState.active
            ? dropState.invalid
              ? "border-amber-400 bg-amber-50/60 dark:border-amber-700 dark:bg-amber-950/20"
              : "border-[var(--primary)] surface-glass-elevated liquid-sheen shadow-[0_0_30px_var(--glow-primary)]"
            : "border-[var(--primary)]/30 surface-glass-base hover:border-[var(--primary)]/60 hover:surface-glass-elevated hover:shadow-[0_0_15px_var(--glow-primary)]"
