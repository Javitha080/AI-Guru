...
class NetworkSettingsUpdate(BaseModel):
    ...
    # Parent Portal LAN access: bind the backend to 0.0.0.0 on next start.
...
def _network_settings_payload() -> dict[str, Any]:
    ...
    return {
        "settings": {
            ...
            "lan_access_enabled": bool(file_system.get("lan_access_enabled", False)),
        },
        "effective": {
            ...
            "lan_access_enabled": bool(effective_system.get("lan_access_enabled", False)),
        },
        "auth": {
    ...
    service.save_system(
        {
            **current,
            ...
            "lan_access_enabled": bool(payload.lan_access_enabled),
        }
    )
    return _network_settings_payload()
