...
async def lifespan(app: FastAPI):
    ...
    # Parent notification outbox: start the delivery worker so notifications
    # queued while the app was offline flush as soon as we're back.
    try:
...
# Public routers — require no authentication token
...
@app.get("/")
async def root():
    return {"message": "Welcome to AI Guru API"}
