...
_ASCII_LOGO = r"""    _    ___    ____ _   _ ____  _   _ 
   / \  |_ _|  / ___| | | |  _ \| | | |
  / _ \  | |  | |  _| | | | |_) | | | |
 / ___ \ | |  | |_| | |_| |  _ <| |_| |
...
LABELS: dict[str, dict[str, str]] = {
    "en": {
        "tagline": "Agent-Native Intelligent Tutoring & Study Platform",
        ...
        "init.next_step": "Run `deeptutor start` to launch AI Guru.",
        "init.choice": "Choice",
        ...
        "start.port_in_use": (
            "AI Guru cannot start because port(s) already in use: {ports}. "
    ...
    "zh": {
        ...
        "init.next_step": "运行 `deeptutor start` 启动 AI Guru。",
        "init.choice": "请选择",
...
def render_banner(language: str | None, *, mode_key: str | None = None) -> Panel:
    ...
    return Panel(
        Align.left(body),
        title="[bold bright_cyan]AI Guru[/]",
